...
def train_cnn(model_id):
    ...
    params = db.get_hyper_parameters(model_id)
    ...
    with graph.as_default():
        ...
        with sess.as_default():
            ...
            out_dir = os.path.abspath(os.path.join(os.path.curdir, "trained_model/trained_model_" + str(model_id)))
            ...
            for train_batch in train_batches:
                ...
                if current_step % params['evaluate_every'] == 0:
                    ...
                    db.insert_model_accuracy(dev_accuracy, current_step, model_id)
